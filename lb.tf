...
resource aws_lb_listener_rule block_header_server {
    listener_arn = aws_lb_listener.public_server_https.arn
    priority = 100
...
resource aws_lb_listener_rule block_header_admin {
    listener_arn = aws_lb_listener.public_admin_https.arn
    priority = 100
...
resource aws_lb_listener_rule block_header_client {
    listener_arn = aws_lb_listener.public_client_https.arn
    priority = 100
